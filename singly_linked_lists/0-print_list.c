...
size_t print_list(const list_t *h)
{
	...
	/*Se inicia un bucle 'while' que recorre la lista mientras el puntero 'h' no sea NULL.*/
	while (h != NULL)
	{	
	...
	/*La función devuelve el valor de 'count', que representa la cantidad de nodos en la lista.*/
	return (count);
}
